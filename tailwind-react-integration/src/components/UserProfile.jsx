...
function UserProfile() {
    return (
      <div className="user-profile bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs  
                      sm:max-w-sm md:max-w-sm mx-auto my-20 rounded-lg shadow-lg 
                      ">
        <img className="rounded-full w-36 sm:w-24 sm:h-24 md:w-36 md:h-36 h-36 mx-auto" src="https://via.placeholder.com/150" alt="User" />
